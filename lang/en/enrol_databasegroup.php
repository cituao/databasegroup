...
/**
 * Strings for component 'enrol_databasegroup', language 'en'.
 *
 * @package   enrol_databasegroup
 * @copyright 1999 onwards Jesus Marquez  {@link http://moodle.com}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

$string['database:config'] = 'Configure databasegroup enrol instances';
$string['database:unenrol'] = 'Unenrol suspended users';
$string['dbencoding'] = 'Databasegroup encoding';
$string['dbhost'] = 'Databasegroup host';
$string['dbhost_desc'] = 'Type databasegroup server IP address or host name. Use a system DSN name if using ODBC.';
$string['dbname'] = 'Databasegroup name';
$string['dbname_desc'] = 'Leave empty if using a DSN name in databasegroup host.';
$string['dbpass'] = 'Databasegroup password';
$string['dbsetupsql'] = 'Databasegroup setup command';
$string['dbsetupsql_desc'] = 'SQL command for special databasegroup setup, often used to setup communication encoding - example for MySQL and PostgreSQL: <em>SET NAMES \'utf8\'</em>';
...
$string['dbtype'] = 'Databasegroup driver';
$string['dbtype_desc'] = 'ADOdb databasegroup driver name, type of the external database engine.';
$string['dbuser'] = 'Databasegroup user';
...
$string['pluginname'] = 'External database group';
$string['pluginname_desc'] = 'Yu can use an external database group (of nearly any kind) to control your enrolments. It is assumed your external database contains at least a field containing a course ID, and a field containing a user ID. These are compared against fields that you choose in the local course and user tables.';
...
$string['remotegroupfield_desc'] = 'The name of the field group in the remote table';
$string['remoteuserfield'] = 'Remote user field';
$string['settingsheaderdb'] = 'External database group connection';
